...
public class ItemBlockScaffold extends ItemBlock {
    ...
    public EnumActionResult onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos,
		...
		EnumActionResult result = onItemUseNoSound(stack, playerIn, worldIn, pos, facing, hitX, hitY, hitZ);
	...
	public EnumActionResult onItemUseNoSound(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
